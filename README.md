...
## Project and deployment references

- Public repository: [cd-Movie-Picture-Pipeline](https://github.com/mohit8890/cd-Movie-Picture-Pipeline)
- Backend LoadBalancer: [Open backend](http://a5036c43ff125488bb9bf22d514dedb6-1835778001.us-east-1.elb.amazonaws.com)
- Backend API: [View movies API](http://a5036c43ff125488bb9bf22d514dedb6-1835778001.us-east-1.elb.amazonaws.com/movies)
- Frontend Application: [Open deployed frontend](http://aa5ae493d91f0443a8d6b4c5ad31038d-581699618.us-east-1.elb.amazonaws.com)
- GitHub Actions: [View workflow runs](https://github.com/mohit8890/cd-Movie-Picture-Pipeline/actions)
- Successful frontend deployment: [View run](https://github.com/mohit8890/cd-Movie-Picture-Pipeline/actions/runs/33971572435)
- Successful backend deployment: [View run](https://github.com/mohit8890/cd-Movie-Picture-Pipeline/actions/runs/33972757248)

The four required workflows are kept under `.github/workflows/`: frontend CI/CD and backend CI/CD. The submission evidence page contains direct public links to successful runs and ready-to-copy Student Note text.
...
They also use the optional repository variables `AWS_REGION` (defaults to `us-east-1`) and `MOVIE_API_URL`. Set `MOVIE_API_URL` to the reachable URL of the deployed backend service before running the frontend deployment workflow. The URL is embedded in the frontend bundle during its Docker build.
...
* Public repository: https://github.com/mohit8890/cd12354-Movie-Picture-Pipeline
* Backend LoadBalancer: http://a5036c43ff125488bb9bf22d514dedb6-1835778001.us-east-1.elb.amazonaws.com
* Backend API: http://a5036c43ff125488bb9bf22d514dedb6-1835778001.us-east-1.elb.amazonaws.com/movies
* Frontend Application: [Open deployed frontend](http://aa5ae493d91f0443a8d6b4c5ad31038d-581699618.us-east-1.elb.amazonaws.com)
* Frontend LoadBalancer: http://aa5ae493d91f0443a8d6b4c5ad31038d-581699618.us-east-1.elb.amazonaws.com# Movie Picture Pipeline
...
* Backend LoadBalancer: http://a5036c43ff125488bb9bf22d514dedb6-1835778001.us-east-1.elb.amazonaws.com
* Backend API: http://a5036c43ff125488bb9bf22d514dedb6-1835778001.us-east-1.elb.amazonaws.com/movies
* Frontend LoadBalancer: http://aa5ae493d91f0443a8d6b4c5ad31038d-581699618.us-east-1.elb.amazonaws.com
* Frontend Continuous Integration: https://github.com/mohit8890/cd-Movie-Picture-Pipeline/actions
* Backend Continuous Integration: https://github.com/mohit8890/cd-Movie-Picture-Pipeline/actions
* Successful frontend deployment run: https://github.com/mohit8890/cd-Movie-Picture-Pipeline/actions/runs/33971572435
* Successful backend deployment run: https://github.com/mohit8890/cd-Movie-Picture-Pipeline/actions/runs/33972757248
* [Complete submission evidence](docs/evidence.md), including all four successful workflow runs
